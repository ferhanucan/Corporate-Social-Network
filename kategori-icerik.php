...
if (!ctype_digit($_GET['kp'])) {
  header('Location:profil.php?kategori=alanyok');
  exit();
}elseif (strlen($_GET['kp']) < 1 or strlen($_GET['kp']) > 2) {
  header('Location:profil.php?kategori=alanyok');
  exit();
}elseif($_GET['kp']=="2") { 
  $grup_no = 2;
  ...
  header('Location:profil.php?kategori=yok');
  exit();
} ?>
...
$goster = 30;
$say=$db->prepare("SELECT * from paylasim where paylasim_kategori=:kategori");
$say->execute(array(
 'kategori' => $grup_no));
	...
	<div class="analiz-pb">
        ...
        <table class="tableclass">
          ...
          <thead>
            <tr>
              <th class="ptabb">
               <div class="analiz-paylasim-text2">
                <span>Kategori</span><br> <?php echo $kategori_ismi; ?>
              </div> 
            </th>

            <th class="ptabo">
             <div class="analiz-paylasim-text2">
               <span>Paylaşım</span><br> <?php echo (number_format($toplamveri)); ?>
             </div>
           </th>

           <th class="ptabs">
             <div class="analiz-paylasim-text2">
               <a href="<?php echo $kategori_link; ?>" class="btn-h red-tooltip" aria-hidden="true" data-toggle="tooltip" data-placement="bottom"><i class="fa fa-refresh" aria-hidden="true"></i></a>
             </div>
           </th>
         </tr>
       </thead>
            ...
            <tr>
              ...
              <th class="asay-td">
                ...
                <div class="pme-box-text">
                  <?php echo $kategori_ismi; ?> <br>
                  <span><?php echo $kategori_ismi; ?> kategorisindeki paylaşımlar</span>
                </div>
...
$paylasim_icerik = $db->prepare("SELECT * from paylasim where paylasim_kategori=:p_kate order by paylasim_id DESC limit $listele, $goster");
        ...
        <table class="tableclass">
          <thead>
            <tr>
              <th class="prof_th">
                <div class="minakarti">
                  <a href="<?php if ($mod['paylasim_code']==$uyecodes) { ?>profil.php?profil=senin&kp=1<?php }else{ ?>kullanici.php?ara=<?php echo $mod['paylasim_profil_code']; ?>&kp=<?php echo $grup_no; ?>&ci=2<?php } ?>">
              ...
              <th class="ka_sa">
                ...
                <div class="pctype">
                  <div class="text-pylsm-yazi"><a href="<?php if ($mod['paylasim_code']==$uyecodes) { ?>profil.php?profil=senin&kp=1<?php }else{ ?>kullanici.php?ara=<?php echo $mod['paylasim_profil_code']; ?>&kp=<?php echo $grup_no; ?>&ci=2<?php } ?>"><?php echo $mod['paylasim_adsoyad']; ?></a><?php if ($uy_li['uye_profil_onay'] == 1) { ?><i class="fa fa-check-circle-o onaytype onay-tooltip" aria-hidden="true" aria-hidden="true" data-toggle="tooltip" data-placement="right"></i><?php } ?> - <span><?php echo $uy_li['uye_departman']; ?> DEPARTMANI -
                    <?php if ($mod['paylasim_meslek_grup'] > 0 and $_SESSION['sessizin'] == 1) { ?>
                      <a href="meslek-alani.php?m=<?php echo $mod['paylasim_meslek_grup']; ?>"><?php echo $mod['paylasim_meslekadi']; ?></a>
                    <?php } else {
              ...
              <div class="mobtype">
                <div class="text-pylsm-yazi"><a href="<?php if ($mod['paylasim_code']==$uyecodes) { ?>profil?profil=senin&kp=1<?php }else{ ?>kullanici?ara=<?php echo $mod['paylasim_profil_code']; ?>&kp=<?php echo $grup_no; ?>&ci=2<?php } ?>"><?php echo $mod['paylasim_adsoyad']; ?></a><?php if ($uy_li['uye_profil_onay'] == 1) { ?><i class="fa fa-check-circle-o onaytype onay-tooltip" aria-hidden="true" aria-hidden="true" data-toggle="tooltip" data-placement="right" data-original-title="Onaylı Profil"></i><?php } ?>
              </div>
            </div>
...
<?php if ($toplamveri > 0) { ?>
	<div class="sayfalama-style">
		<div class="sayfalama-panel">
          ...
          <?php if ($sayfa > 1) { ?>
           <a href="<?php echo $kategori_link; ?>&sayfa=<?=$sayfa - 1?>" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" data-original-title="Önceki Sayfa"><i class="fa fa-chevron-left"></i></a>
         <?php } ?>


         <?php if ($sayfa != $sayfa_sayisi) { ?>
           <a href="<?php echo $kategori_link; ?>&sayfa=<?=$sayfa + 1?>" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" data-original-title="Sonraki Sayfa"><i class="fa fa-chevron-right"></i></a>
         <?php } ?>
